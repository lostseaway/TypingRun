var BackgroundLayer = cc.Node.extend({
    ...
    update: function(dt){
        ...
        if(cc.rectGetMaxX(bbs1)<=0)this.sky.setPosition(cc.p(this.sky2.getPosition().x+1920,0));
        if(cc.rectGetMaxX(bbs2)<=0)this.sky1.setPosition(cc.p(this.sky.getPosition().x+1920,0));
        if(cc.rectGetMaxX(bbs3)<=0)this.sky2.setPosition(cc.p(this.sky1.getPosition().x+1920,0));
    }
});